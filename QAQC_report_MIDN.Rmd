...
# Error check:
qaqc <- forestMIDN::joinLocEvent(QAQC = TRUE) %>%
...
quad_tab_ta <- if(nrow(quad_spp) > 0){ # this is prelim df to quad_spp_wide
                   ...
                   row_spec(nrow(quad_spp_wide2), bold = T, extra_css = "border-bottom: 1px solid #000000;",
                             background = ifelse(quad_spp_wide2[nrow(quad_spp_wide2), 3] < 0.95, diff_bad, "#ffffff"))
                   } 
quad_tab_ta
...
#### Taxonomic Accuracy {.tabset}
<details open><summary><h3>Quadrat Species</h3></summary>
...
<details open><summary><h3>Quadrat Seedlings</h3></summary>
