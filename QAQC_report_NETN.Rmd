...
folcond_tab <- kable(folcond_wide %>% select(TagCode:Txt_Leaves_Aff_W_Q), 
              ...
              kable_styling(fixed_thead = TRUE, bootstrap_options = 'condensed', 
                    ...
                    column_spec(2:3, background = check_fol(folcond_wide, "Leaves_Aff_C_code_C", "Leaves_Aff_C_code_Q")) %>% 
                    column_spec(seq(3, 21, 2), border_right = TRUE) %>% 
                    column_spec(4:5, background = check_fol(folcond_wide, "Leaf_Area_C_code_C", "Leaf_Area_C_code_Q")) %>% 
                    column_spec(6:7, background = check_fol(folcond_wide, "Leaves_Aff_H_code_C", "Leaves_Aff_H_code_Q")) %>% 
                    column_spec(8:9, background = check_fol(folcond_wide, "Leaf_Area_H_code_C", "Leaf_Area_H_code_Q")) %>% 
                    column_spec(10:11, background = check_fol(folcond_wide, "Leaves_Aff_L_code_C", "Leaves_Aff_L_code_Q")) %>% 
                    column_spec(12:13, background = check_fol(folcond_wide, "Leaves_Aff_N_code_C", "Leaves_Aff_N_code_Q")) %>% 
                    column_spec(14:15, background = check_fol(folcond_wide, "Leaf_Area_N_code_C", "Leaf_Area_N_code_Q")) %>% 
                    column_spec(16:17, background = check_fol(folcond_wide, "Leaves_Aff_O_code_C", "Leaves_Aff_O_code_Q")) %>% 
                    column_spec(18:19, background = check_fol(folcond_wide, "Leaves_Aff_S_code_C", "Leaves_Aff_S_code_Q")) %>% 
                    column_spec(20:21, background = check_fol(folcond_wide, "Leaves_Aff_W_code_C", "Leaves_Aff_W_code_Q")) %>% 
                    scroll_box(width = "1100px")
...
sap_sum_tab <- kable(sap_sum %>% select(-dbh_diff), format = 'html', align = 'c', #table.attr = "style='width:48%;'",
               ...
               column_spec(2:3, background = check_saps(sap_sum, "num_saps_Crew", "num_saps_QAQC")) %>% 
