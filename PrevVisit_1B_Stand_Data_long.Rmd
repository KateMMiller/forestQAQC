...
stand_plot2 <- stand_plot1 |> 
  select(Plot_Name, Unit, Year = SampleYear, 
         Orientation, Aspect, 
         PhysioCode = PhysiographyCode, PhysioClass = PhysiographySummary, 
         PhysioDetail = PhysiographyLabel, Stunted = IsStuntedWoodland, 
         Plot_Slope = PlotSlope, Stand_Structure:Txt_Water) |> 
...
stand_tab <- kable(stand_plot |> select(Type, Metric, Value),
             ...
             #column_spec(0, width = "10px") |> 
             column_spec(1:2, width = "15px") |> 
             #column_spec(2, width = "20px") |> 
...
```{r treemap, out.width = "160%", fig.align = 'right'}
