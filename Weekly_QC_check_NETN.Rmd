...
forestNETN::importCSV(path = "D:/NETN/Monitoring_Projects/Forest_Health/2021_data/weekly_databases",
                     zip_name = "NETN_Forest_20210625_THING1.zip")
# forestNETN::importCSV(path = "D:/NETN/Monitoring_Projects/Forest_Health/2021_data/weekly_databases", 
#                       zip_name = "NETN_Forest_20210625_THING2.zip")
...
source("Weekly_QC_compile_data.R")
```
...
```{r plot_tab, echo = FALSE, include = include_plot_tab, results = 'asis'}
cat("### Plot & Visit Data {.tabset}", "\n")

```

```{r plot_tables, echo = FALSE, include = include_plot_tab}
...
```{r micro_tab, echo = FALSE, include = include_micro_tab, results = 'asis'}
cat("### Microplot {.tabset}", "\n")

```

```{r micro_tables, echo = FALSE, include = include_micro_tab}
...
```{r quad_tab, echo = FALSE, include = include_quad_tab, results = 'asis'}
cat("### Quadrat {.tabset}", "\n")

```

```{r quad_tables, echo = FALSE, include = include_quad_tab}
...
```{r addspp_tab, echo = FALSE, include = include_addspp_tab, results = 'asis'}
cat("### Additional Species {.tabset}", "\n")

```

```{r addspp_tables, echo = FALSE, include = include_addspp_tab}
...
```{r cwd_tab, echo = FALSE, include = include_cwd_tab, results = 'asis'}
cat("### CWD {.tabset}", "\n")

```

```{r cwd_tables, echo = FALSE, include = include_cwd_tab}
...
```{r soil_tab, echo = FALSE, include = include_soil_tab, results = 'asis'}
cat("### Soil {.tabset}", "\n")

```

```{r soil_tables, echo = FALSE, include = include_soil_tab}
...
```{r plantID_tab, echo = FALSE, include = include_plantID_tab, results = 'asis'}
cat("### Plant ID {.tabset}", "\n")

```

```{r plantID_tables, echo = FALSE, include = include_plantID_tab}
...
```{r ISED_tab, echo = FALSE, include = include_ISED_tab, results = 'asis'}
cat("### Early Detections {.tabset}", "\n")

```

```{r ISED_tables, echo = FALSE, include = include_ISED_tab}
