...
#------ PrevVisit_Plot_Viewer_NETN_Indiv.Rmd renders each plot's report within the plot-named tabs. 
#       This report shows the order of the modules that are rendered and allows you to turn them off, if they're failing.
#---------- PrevVisit_1A_Stand_Data_wide.Rmd (and others with numbers) are individual data modules. If you try to
...
#           are located on the Z drive, your laptop, or an external drive. The file that needs to be checked is
#           PrevVisit_5A_Photopoints_wide.Rmd
```
...
#park = "SAGA"; year = as.numeric(2018)
soil_sch <- readxl::read_xlsx("../data/12-year_Soil_Sample_Schedule.xlsx", sheet = params$parkcode)
...
plot_info <- joinLocEvent(park = park, from = year, to = year, output = 'verbose') |> 
